...
class Feeder(object):
    ...
    def __init__(self, x, o, ext_inp, ext_oup,
...
ext_oup = np.load('dev/train/ext_oup.npy')
...
train_feeder = Feeder(x, o, ext_inp, ext_oup,
...
val_feeder = Feeder(x, o, ext_inp, ext_oup,
                    mask1, mask2, mask3, dis, poi, y)
...
for i in range(train_epoch):
    ...
    for _ in range(train_feeder.step_per_epoch):
        in1, in2, in3, in4, in5, in6, in7, in8 = train_feeder.feed()
